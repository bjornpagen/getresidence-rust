...
pub async fn privacy_handler(_req: Request, _ctx: RouteContext<()>) -> Result<Response> {
    let body = html! {
        section #privacy {
            h1 { "Privacy Policy" }
            p { "Your privacy is important to us. It is getresidence.org's policy to respect your privacy regarding any information we may collect from you across our website, https://getresidence.org, and other sites we own and operate." }
